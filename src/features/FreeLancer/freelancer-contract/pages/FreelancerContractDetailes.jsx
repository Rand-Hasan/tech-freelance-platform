...
// import { AcceptCancelContract, GetRespondByContract, RejectCancelContract, ReturnToCancelContract } from "../../../Client/client-contracts/services/api_contract";
...
//     setCancelRequested(savedCancelRequest === "true");
// }, [id]);
//   useEffect(() => {
...
// const isRequester =
//     cancellationRequest?.client_id !== null;
...
//   try{ 
//     const res = await axios.post(`${baseURL}${ReturnToCancelContract}${id}`,{},{
//       headers:{Authorization:`Bearer ${token}`}
//     })
//     console.log(res.data);
...
//             : "The client requested to cancel this contract."
//           }
//         </p>
...
export default function FreelancerContractDetailes() {
  ...
  /*
  ============================================================
  تحميل حالة Cancel / Withdraw من localStorage
  ============================================================
  */
