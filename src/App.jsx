    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/clientlayout" element={<ClientLayout />}>
          ...
          <Route
            path="messageClient/:freelancer_id"
            element={<MessageClient />}
          />
          ...
          <Route path="projectdetails/:id" element={<ProjectDetails />}>
            ...
            <Route
              path="matched-freelancers"
              element={<MatchedFreelancers />}
            />
        ...
        <Route path="/freelancerlayout" element={<FreeLancerLayout />}>
          ...
          <Route
            path="FreelancerContractDetailes/:id"
            element={<FreelancerContractDetailes />}
          />
          {/* project freelancer */}
          <Route path="projectfree" element={<ProjectFree />}>
            <Route path="projectproposal" element={<ProjectProposal />} />
            <Route
              path="projectproposaldetails/:id"
              element={<ProjectProposalDetails />}
            />
          ...
          <Route path="showprofile" element={<ShowProfile />}>
            ...
            <Route
              path="showportofoliodetails"
              element={<Showportofoliodetails />}
            />
          </Route>
        </Route>
        ///////////////Admin//////////
